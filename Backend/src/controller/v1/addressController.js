...
const getDefaultAddress = async (req, res) => {
    try {
        ...
        mixpanel.track('Default Address Viewed', {
            distinct_id: decoded.id,
...
const getAddressForUser = async (req, res) => {
    try {
        ...
        mixpanel.track('All Addresses Viewed', {
            distinct_id: customer_id,
            address_count: addresses ? addresses.length : 0
        });
...
const updateAddress = async (req, res) => {
    try {
        ...
        mixpanel.people.set(customer_id, {
            '$last_address_updated': new Date().toISOString(),
