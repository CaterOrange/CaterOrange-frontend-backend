...
const insertCartToOrder = async (customer_generated_id, order_details, total_amount, paymentid, customer_address, payment_status,corporate_order_status) => {
    try {
        ...
        const result = await client.query(
            ...
            [customer_generated_id, JSON.stringify(order_details), total_amount, paymentid, customer_address, payment_status,corporate_order_status]
        );
