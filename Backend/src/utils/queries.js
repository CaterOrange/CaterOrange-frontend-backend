...
JOIN corporateorder_details cod ON cod.order_detail_id = ANY(co.order_details::int[])
LEFT JOIN corporate_category cc ON cod.category_id = cc.category_id
WHERE co.customer_generated_id = $1 AND co.payment_status='Success'
`,
GET_ORDER_GENID: `
SELECT corporateorder_generated_id FROM corporate_orders WHERE customer_generated_id=$1
`,
GET_ORDER_EVENTGENID: `
SELECT eventorder_generated_id FROM event_orders WHERE customer_generated_id=$1
`,
getCartCountById:`
...
SET tag = $3, pincode = $4, line1 = $5, line2 = $6, location = $7, ship_to_name = $8, ship_to_phone_number = $9
WHERE customer_id = $1 AND address_id = $2 
RETURNING *;
`,
  
DELETE_ADDRESS: `DELETE FROM address WHERE customer_id = $1 AND address_id = $2`
