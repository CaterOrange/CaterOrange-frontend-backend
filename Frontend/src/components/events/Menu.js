...
// // onClearCart();
// // // Optionally reset payment success to prevent repeated calls
...
//  `${process.env.REACT_APP_URL}/api/pay`,
//  {
//  corporateorder_id: respond.eventorder_generated_id,
//  amount: totalAmount,
//  },
...
//  currentUser = JSON.parse(localStorage.getItem('userDP'))?.email;
//  setPaymentSuccess(true);
//  } else {
