...
//     // Regular expression to match only letters and spaces (for text fields)
//     const letterRegex = /^[A-Za-z\s]+$/;
//     // Regular expression for flat number: allows letters and numbers (alphanumeric)
//     const flatNumberRegex = /^[A-Za-z0-9\s]+$/;
//     // Regular expression for pincode: allows only digits and must be 6 characters long
...
//     // Validate Flat Number (alphanumeric: letters and numbers allowed)
...
//  ? `http://localhost:4000/address/api/edit/${existingAddress.address_id}`
