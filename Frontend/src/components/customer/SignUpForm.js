    ...
    if (isValid) {
      try {
        ...
        if (error.response && error.response.data) {
          ...
          // Map API error messages to corresponding fields
          if (errorData.message) {
            if (errorData.message.includes('Email')) {
              newFieldErrors.email = errorData.message;
              fieldToClear = 'email';
            } else if (errorData.message.includes('phone')) {
              newFieldErrors.phone = errorData.message;
              fieldToClear = 'phone';
            } else if (errorData.message.includes('Name')) {
              newFieldErrors.name = errorData.message;
              fieldToClear = 'name';
            } else if (errorData.message.includes('Password')) {
              newFieldErrors.password = errorData.message;
              fieldToClear = 'password';
            } else {
              newFieldErrors.general = errorData.message;
            }
          }
