...
const Header2 = ({ user }) => {
  ...
  return (
    <>
      ...
      <div
        ref={sidenavRef}
        className={`fixed top-0 left-0 h-full w-70 bg-white text-black shadow-lg transform transition-transform duration-300 ease-in-out ${isSidenavOpen ? 'translate-x-0' : '-translate-x-full'
