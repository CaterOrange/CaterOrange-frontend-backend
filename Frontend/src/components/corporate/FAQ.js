...
const FAQ = () => {
  ...
  const faqItems = [
    {
      question: "How do I place an order?",
      answer: "You can place an order through our website at app.caterorange.com. Browse our menu, select your items, choose the delivery date and time, and proceed to checkout. You will receive a confirmation email once your order is placed."
    },
    {
      question: "What locations do you deliver to?",
      answer: "CaterOrange delivers to various corporate offices, events, and gatherings across major cities. Enter your delivery address during checkout to check availability in your area."
    },
    {
      question: "Do you offer meal subscriptions?",
      answer: "Yes! We provide flexible meal subscription plans for businesses and individuals. You can customize your subscription and manage deliveries through your CaterOrange account."
    },
    {
      question: "Can I modify or cancel my order?",
      answer: "Orders can be modified or canceled up to 24 hours before the scheduled delivery time. For last-minute changes, please contact our support team immediately."
    },
    {
      question: "What payment methods do you accept?",
      answer: "We accept major credit/debit cards, UPI, and corporate invoicing options. All transactions are securely processed on our platform."
    },
    {
      question: "How do I track my order?",
      answer: "Once your order is out for delivery, you'll receive a tracking link via email or SMS. You can also track your order in real-time through the CaterOrange dashboard."
    },
    {
      question: "Do you provide catering for large events?",
      answer: "Yes! CaterOrange specializes in corporate catering and large events. Contact us for custom menu options and bulk order discounts."
    },
    {
      question: "How do I contact customer support?",
      answer: "You can reach our support team via email at support@caterorange.com or call us at 8123700851 . Support is available Monday to Friday from 8:00 AM to 6:00 PM."
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-10 min-h-screen">
      <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6">
        ...
        <div className="mb-6">
          <p className="mb-4">
            Find answers to the most common questions about our meal delivery service. 
