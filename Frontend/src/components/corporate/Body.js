...
//   const [displayAddress, setDisplayAddress] = useState('');
//   const [addressToSend, setAddressToSend] = useState([]);
//   const [showNotification, setShowNotification] = useState(true); // New state for notification
...
//   const [showDateComponent, setShowDateComponent] = useState(false); // State to control DateComponent visibility

//   const handleNotificationClick = () => {
//       setShowNotification(false); // Hide notification
//       setShowDateComponent(true); // Show DateComponent
//   };
...
//   return (
//     <div className="relative pb-20 min-h-screen">
//       {showNotification && <Notification onClick={handleNotificationClick} />}
...
//           </div>
//         ) : (
//           <AddressForm onAddressAdd={handleAddressUpdate} onAddressSelect={handleAddressSelect} onClose={() => setShowMap(false)} />
//         )}
//       </div>
