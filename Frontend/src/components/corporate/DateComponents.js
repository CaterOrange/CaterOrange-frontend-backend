                ...
                <div className="border-t border-gray-200">
                    <div className="p-2 flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                        <div className="text-lg font-semibold font-medium text-gray-700 font-serif">
                            Chosen Dining Days: {selectedDates.length}
                        </div>
                        <div className="flex space-x-3">
                            <button 
                                onClick={handleclear}
                                className="px-4 py-2 text-sm font-medium text-white bg-red-500 rounded-full hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-300 transition-colors duration-200"
                            >
                                Clear
                            </button>
                            <button 
                                onClick={handleSaveDates}
                                className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-colors duration-200"
                            >
                                Save
                            </button>
                        </div>
